...
Another thing that is interesting to look at it the trends of the weather over a daily period. I created a table of means that contains the mean values for all columns of our original dataset but applied to all of our data. Here is what we got:
        
                                   ## Table of Means
 <img src="https://raw.githubusercontent.com/dallinmason/stat386-projects/main/assets/images/Table.PNG" alt="" style="width:500px;"/>
